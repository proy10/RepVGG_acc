...
create_floorplan -core_utilization 0.6 -left_io2core 30.0 -bottom_io2core 30.0 -right_io2core 30.0 -top_io2core 30.0 -keep_macro_place

create_fp_virtual_pad -nets VSS -point {0 20}
create_fp_virtual_pad -nets VDD -point {0 60}
create_fp_virtual_pad -nets VSS1 -point {0 20}
create_fp_virtual_pad -nets VDD1 -point {0 60}
